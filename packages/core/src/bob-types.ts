...
export type Languages = Array<keyof typeof LanguagesEnum>;
export type supportLanguages = Languages;
export type Language = keyof typeof LanguagesEnum;

// https://ripperhe.gitee.io/bob/#/plugin/quickstart/translate
export type Translate = (query: TranslateQuery, completion: Completion) => void;
export type completionResult = { result: Result };
export type CompletionResult = { error: ServiceError };
export type Completion = (args: completionResult | CompletionResult) => void;
...
export type Query = TranslateQuery | OcrQuery | TTSQuery;
...
export interface OptionObject {
  ...
  menuValues?: MenuObject[]; // export type 为 menu 时必须有菜单选项数组，详情见 menu object。
}
...
export type HttpResponsePromise<T = any> = Promise<HttpResponse<T>>;
...
export type ServiceErrorType = keyof typeof ServiceErrorEnum;
...
export type Result = TranslateResult | OcrResult | TTSResult;
